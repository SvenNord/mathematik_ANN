...
class SequentialNet:
  ...
  def add_dense(self, n, afun=None, optim=None, initializer=None, kernel_regularizer=None):

    self.layers.append(DenseLayer(self.no, n, afun, optim), initializer, kernel_regularizer)
    self.no = n
